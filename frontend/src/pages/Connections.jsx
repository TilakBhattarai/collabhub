...
export default function Connections() {
    ...
    const acceptConnection = async (connection_id) => {
        ...
        try {
            ...
            setRequests((prev) =>
                prev.filter(
                    (request) => request.id != connection_id
                )
            );
                    ...
                    {requests.length > 0 ? (
                        ...
                        <div className="rounded-md border border-dashed border-gray-300 bg-white px-6 py-12 text-center">
                            ...
                            <button
                                ...
                                className="mt-5 cursor-pointer rounded-md bg-violet-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-violet-700"
                            >
                                Find People
                            </button>
                        </div>
                    ...
                    {myConnections.length > 0 ? (
                        ...
                        <div className="rounded-md border border-gray-200 bg-white">
                            ...
                            {myConnections.map((connection) => (
                                <div
                                    key={connection.id}
                                    className="flex flex-col gap-4 border-b border-gray-100 p-4 last:border-0 sm:flex-row sm:items-center sm:justify-between"
                                >
                                    ...
                                    <div className="flex shrink-0 gap-2">
                                        ...
                                        <button
                                            ...
                                            type="button"
                                            className="cursor-pointer rounded-md border border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-700 transition hover:bg-gray-50"
                                        >
                                            View
                                        </button>
                        ...
                        <div className="rounded-md border border-dashed border-gray-300 bg-white px-6 py-12 text-center">
                            ...
                            <p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-gray-500">
                                Start connecting with people you would
                                like to build with.
                            </p>
